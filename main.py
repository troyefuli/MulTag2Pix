...
# 我要复现加skeleton的代码！
# from tag2pix_skeleton import tag2pix
# 复现direct 在输入＋skeleton的方法！
# from tag2pix_inputskeleton import tag2pix
# 复现源代码
# from tag2pix_real import tag2pix
...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default='tag2pix', choices=['tag2pix', 'senet', 'resnext', 'catconv', 'catall', 'adain', 'seadain','mynet','mynet_1','mynet_2','mynet_3','mynet_4','mynet_5','convnet_dev_skeleton_noadain','mynet_7','mynet_8','AFF_cat','NAM_conv','CBAM_cat','convnet_dev','network_skeleton','convnet_dev_MSCAM','convnet_dev_NAM','convnet_dev_EPSA','convnet_dev_CA','convnet_dev_CA_Att','convnet_dev_CARAFE','convnet_dev_CBAM_Att','convnet_dev_CBAM_Att_CARAFE','convnet_dev_changeD','convnet_dev_CBAM_skeleton_adain','convnet_dev_att_1','convnet_dev_skeleton_adain_noatt','convnet_dev_skeleton','convnet_dev_skeleton_Adain','convnet_dev_skeleton_Adain_NAM','convnet_dev_skeleton_Adain_NAM_gate','convnet_dev_skeleton_NAM_gate','convnet_dev_skeleton_NAMo_gate','convnet_dev_CBAM_skeleton_adain_block','convnet_dev_CBAM_skeleton','network_inputskeleton','convnet_dev_nose'],
    ...
    parser.add_argument('--cit_cvt_weight', type=float, nargs='+', default=[1, 1, 1], help='CIT CVT Loss weight. space-separated')
